...
OFF_TOPIC_MESSAGE = (
    "I'm designed to assist with food-delivery and grocery "
...
SHOW_INPUT_MESSAGE = "Please upload a clear photo of the product"

# --- FIXED (non-LLM) terminal messages for the image-evidence flow ---

AI_GENERATED_MESSAGE = (
    "We couldn't verify this image as an original photo. It looks like an AI-generated one."
)

REFUND_APPROVED_TEMPLATE = (
    "We're sorry about your {item}. Refund/replacement will "
    "be processed within 24 hours. Our customer care will contact you via "
    "telephone."
)

CLAIM_REJECTED_MESSAGE = (
    "We've reviewed the image you shared, but it doesn't "
...
VALIDATION_GAVE_UP_MESSAGE = (
    "We're having trouble processing that image right now. "
...
def response_generator_node(state: GraphState) -> dict:
    ...
    if state.get("is_claim_submitted"):
        message = "Your request is already being reviewed by our team. We'll update you shortly."
        return {
            "final_response": message,
            "tool_usage": None,
            "conversation_resolved": True,
